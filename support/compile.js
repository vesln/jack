/*!
 * jack:: browser build script
 *
 * based on chai-spies browser build
 * https://github.com/logicalparadox/chai-spies/blob/master/support/compile.js
...
applicationJs.compile(function (err, src) {
  ...
  fs.writeFileSync(join(__dirname, '..', 'jack.js'), content, 'utf8');
  console.log('completed: jack.js');
});
